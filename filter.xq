...
//inproceedings[booktitle="PACT"],
//inproceedings[booktitle="CC"],
//inproceedings[booktitle="LCTES"],
//inproceedings[booktitle="ECOOP"],
//inproceedings[booktitle="PEPM"],
//inproceedings[booktitle="PASTE"],
//inproceedings[booktitle="CASES"],
//article[journal="PACMPL"],
//article[journal="Proc. ACM Program. Lang."],
//article[journal="TOPLAS"],
//article[journal="ACM Trans. Program. Lang. Syst."],
//article[journal="TACO"],
//article[journal="ACM Trans. Archit. Code Optim."],
...
//inproceedings[booktitle="PPoPP"],
//inproceedings[booktitle="PMAM@PPoPP"],
//inproceedings[booktitle="GPGPU@PPoPP"],
//inproceedings[booktitle="PPAA@PPoPP"],
//inproceedings[booktitle="WPMVP@PPoPP"],
